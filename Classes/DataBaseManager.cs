...
namespace Bank_App.Forms
{
    ...
    {
        private static string connectionString = "server=sql7.freesqldatabase.com;user=sql7316377;database=sql7316377;password=IOon5ive!;Allow User Variables=True;";
